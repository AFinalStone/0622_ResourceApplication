...
//	private final static String FILE_PATH = "ParseResourceArsc/res/app-release.apk";
	private final static String FILE_PATH = "ParseResourceArsc/res/resources_01.arsc";
