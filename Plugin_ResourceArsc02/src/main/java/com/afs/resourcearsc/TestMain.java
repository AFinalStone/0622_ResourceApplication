...
public class TestMain {
    private final static String ARSC_FILE_IN_PATH = "Plugin_ResourceArsc02/res/resources_01.arsc";
    private final static String ARSC_FILE_OUT_PATH = "Plugin_ResourceArsc02/res/resources.arsc";
    //80F9 82F9
